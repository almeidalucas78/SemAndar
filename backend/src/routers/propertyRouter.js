...
import { getAllProperties, getFilteredProperties } from "../controllers/propertyController.js"; //importa a função getAllProperties do controller.

const PropertyRouter = express.Router(); //cria uma instância do router do express.

// Rota de busca filtrada
PropertyRouter.get("/search", getFilteredProperties);
